...
const ArticlesList: React.FC<ArticlesListProps> = ({
  ...
  const hasArticles =
    articles.length > 0 || (showHighlighted && highlightedArticle);
      ...
      <div className="all-articles-content">
        {showHighlighted && currentPage === 1 && highlightedArticle && (
          <section className="highlighted-article">
            <Link
              to={`/article/${highlightedArticle.id}`}
                    ...
                    <div className="author-info">
                      <div className="author-avatar">
                        {highlightedArticle.authorAvatar ? (
                          ...
                          <span>
                            {getInitials(highlightedArticle.authorName)}
                          </span>
                        )}
                      </div>
                      <Link
                      ...
                      >
                        <span className="author-name">
                          {highlightedArticle.authorName}
                        </span>
                      </Link>
                    </div>
                    <div className="highlight-stats">
                      <span className="highlight-date">
                        {formatDate(highlightedArticle.createdAt)}
                      </span>
                      <span className="dot-sep">•</span>
                      <span className="highlight-read-time">
                        {highlightedArticle.readTime} min read
                      </span>
                      <span className="dot-sep">•</span>
